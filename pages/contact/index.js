          ...
          <div className="grid md:grid-cols-2 gap-12 mb-12">
            <div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-text/80">info@alittlegodtime.org</p>
                </div>
                <div>
                  <h3 className="font-serif text-xl mb-2">Prayer Requests</h3>
                  <p className="text-text/80">prayer@alittlegodtime.org</p>
                </div>
                <div>
                  <h3 className="font-serif text-xl mb-2">Contribution Inquiries</h3>
                  <p className="text-text/80">contribute@alittlegodtime.org</p>
                </div>
              </div>
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="text-text hover:text-secondary">
            ...
            <div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <label htmlFor="subject" className="block font-serif mb-2">
                    Subject
                  </label>
                  <input
                    type="text"
                ...
                <div className="flex items-start space-x-2">
                  <input
                    ...
                    className="mt-1"
                  />
                  <label htmlFor="prayerRequest" className="text-sm text-text/80">
                ...
                <button
                  type="submit"
                  className="w-full bg-secondary text-white py-3 rounded-lg hover:opacity-90 transition font-serif"
                >
                  Send Message
                </button>
              </form>
